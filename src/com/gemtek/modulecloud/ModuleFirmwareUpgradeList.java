...
import com.gemtek.modulecloud.adapter.ModuleFirmwareUpgradeListAdapter;
import com.gemtek.listview_custom.ListViewCustom;

import com.bee.callback.ConnectCallback;
import com.cloudAgent.CloudAgent;

public class ModuleFirmwareUpgradeList extends Activity {
    private Context mContext;
    private ListViewCustom mListViewCustom;
    private List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
    private ModuleFirmwareUpgradeListAdapter mListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListAdapter = new ModuleFirmwareUpgradeListAdapter(mContext, (ArrayList<Map<String, Object>>)list);
        RefreshListView();
    ...
    private void block(final String message) {
       UITools.blockUI(ModuleFirmwareUpgradeList.this, message);
    }
    ...
    private void toast(final String message, final int duration) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(ModuleFirmwareUpgradeList.this, message, duration).show();
            }
        });
    }
    ...
    private void ConnectWithPeer(String peerId) {
        ...
        ModuleCloud.mCloudAgent.connect(peerId, new ConnectCallback() {
            ...
            public void onSuccess(String peerId, final int cid) {
                ...
                upgradefirmware_flow(peerId);
            }
        });
    }

    private void upgradefirmware_flow(String peerId) {
        Intent i = new Intent(ModuleFirmwareUpgradeList.this, FirmwareUpgrade.class);
