...
public class ModuleBluemixSettingListAdapter extends BaseAdapter {
    private LayoutInflater myInflater;
    private ArrayList<Map<String, Object>> list = null;
    private SparseBooleanArray mSelectedItemsIds;

    public ModuleBluemixSettingListAdapter(final Context context, ArrayList<Map<String, Object>> list) {
