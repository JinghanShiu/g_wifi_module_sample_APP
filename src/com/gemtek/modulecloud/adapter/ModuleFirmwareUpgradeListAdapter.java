...
public class ModuleFirmwareUpgradeListAdapter extends BaseAdapter {
    private LayoutInflater myInflater;
    private ArrayList<Map<String, Object>> list = null;
    private SparseBooleanArray mSelectedItemsIds;

    public ModuleFirmwareUpgradeListAdapter(final Context context, ArrayList<Map<String, Object>> list) {
